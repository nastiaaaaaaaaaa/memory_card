...
q8 = Question('Яка найбільша зоря в космосі?', 'UY', 'AY', 'AU', 'YU')
q9 = Question('Хто заснував день космонавтики в україні?', 'Германа Титова,', 'Віктор Ющенко', 'Джо Байден', 'Леонід Кравчук')
q10 = Question('Коли день космонавтики в україні?', '12 квітня,', '6 квітня ', '10 квітня', '10 лютого')
